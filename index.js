...
do {
    console.log(`${chalk.bold.yellowBright(p1.name)} VS ${chalk.red.bold(o1.name)}`);
    ...
    if (ask.option === "Attack") {
        ...
        if (p1.fuel <= 0) {
            console.log(chalk.bgWhite.blueBright.inverse("You Lose, Please Try Again........"));
            process.exit();
        }
        if (o1.fuel <= 0) {
    ...
    if (ask.option === "Drink Potion") {
        p1.fuelIncrease();
        console.log(chalk.green.bgWhiteBright(`You drink a health potion. Your fuel is: ${p1.fuel}`));
    }
    if (ask.option === "Run for your life") {
        console.log(chalk.bgWhite.magentaBright.inverse("You Lose, Please Try Again........"));
        process.exit();
    }
} while (true);
